package com.yibo.saiku.web.rest.objects.acl;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.type.TypeFactory;
import com.yibo.saiku.web.rest.objects.acl.enumeration.AclMethod;
import com.yibo.saiku.web.rest.resources.BasicRepositoryResource2;
  ...
  private Map<String, AclEntry> deserialize( FileObject accessFile ) {
    ...
    try {
      if ( accessFile != null && accessFile.exists() ) {
        ...
        acl = (Map<String, AclEntry>) mapper.readValue( br, TypeFactory.defaultInstance().constructMapType
                ( HashMap.class, String.class, AclEntry.class ) );
//        acl = (Map<String, AclEntry>) mapper.readValue( br, mapper.getTypeFactory().constructMapType
//          ( HashMap.class, String.class, AclEntry.class ) );
      }
    } catch ( Exception e ) {
